...
public class ZestGraphExample extends AbstractZestExample {
	...
	private Graph buildAC(String id) {
		// create nodes "A" to "C"
		List<org.eclipse.gef4.graph.Node> nodes = new ArrayList<org.eclipse.gef4.graph.Node>();
		nodes.addAll(Arrays.asList(
				n(ZestProperties.ELEMENT_LABEL, apple(), ZestProperties.NODE_TOOLTIP, "Alpha",
						ZestProperties.ELEMENT_CSS_ID, id + "Apple"),
				n(ZestProperties.ELEMENT_LABEL, "BananaZ", ZestProperties.NODE_TOOLTIP, "BetaZ",
						ZestProperties.ELEMENT_CSS_ID, id + "Banana"),
				n(ZestProperties.ELEMENT_LABEL, "Carrot", ZestProperties.NODE_TOOLTIP, "Gamma",
						ZestProperties.ELEMENT_CSS_ID, id + "Carrot")));
	...
	private Graph buildAE(String id) {
		// create nodes "A" to "C"
		List<org.eclipse.gef4.graph.Node> nodes = new ArrayList<org.eclipse.gef4.graph.Node>();
		nodes.addAll(Arrays.asList(
